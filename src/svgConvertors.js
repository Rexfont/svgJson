...
function convertRectToPath(attributes) {
...
function ConvertPolylineToPath(attributes) {
    return 'M' + attributes.points;
}

function ConvertPathlineToPath(attributes) {
...
function convertCircleToPath(attributes) {
...
function convertPolyToPath(attributes) {
    return 'M' + attributes.points + 'Z';
}


module.exports = {
  rect: convertRectToPath,
  polyline: ConvertPolylineToPath,
  line: ConvertPathlineToPath,
  circle: convertCircleToPath,
  polygon: convertPolyToPath,
}