...
function generateTTF(font) {
  // contours
  font = fontContours(font);

  // TODO: public_html/test/ax_fontgen/node_modules/svg2ttf/index.js:186
}
...
function fontContours(font) {
  font.forEach((item, key) => item.tag == 'glyph' ? font[key].contour = Helper.getContours(item.attributes.d) : null)
  return font;
}
